function varargout = ImportFromXDF2(varargin)
...
%
%      IMPORTFROMXDF2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMPORTFROMXDF2.M with the given input arguments.
%
%      IMPORTFROMXDF2('Property','Value',...) creates a new IMPORTFROMXDF2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ImportFromXDF2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ImportFromXDF2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ImportFromXDF2

% Last Modified by GUIDE v2.5 26-Jul-2012 19:21:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ImportFromXDF2_OpeningFcn, ...
                   'gui_OutputFcn',  @ImportFromXDF2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ImportFromXDF2 is made visible.
function ImportFromXDF2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ImportFromXDF2 (see VARARGIN)
userData.source = [];
...
% UIWAIT makes ImportFromXDF2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ImportFromXDF2_OutputFcn(hObject, eventdata, handles) 
...
[FileName,PathName] =  uigetfile2({'*.xdf;*.xdfz','Extensible data format (*.xdf, *.xdfz)'},'Select the source file');
