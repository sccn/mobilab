function varargout = ImportFromDatariver(varargin)
...
%      singleton*.
%
%      H = IMPORTFROMDATARIVER returns the handle to a new IMPORTFROMDATARIVER or the handle to
%      the existing singleton*.
%
%      IMPORTFROMDATARIVER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMPORTFROMDATARIVER.M with the given input arguments.
%
%      IMPORTFROMDATARIVER('Property','Value',...) creates a new IMPORTFROMDATARIVER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ImportFromDatariver_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ImportFromDatariver_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ImportFromDatariver

% Last Modified by GUIDE v2.5 29-Aug-2011 13:56:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ImportFromDatariver_OpeningFcn, ...
                   'gui_OutputFcn',  @ImportFromDatariver_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ImportFromDatariver is made visible.
function ImportFromDatariver_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ImportFromDatariver (see VARARGIN)
userData.source = [];
...
% UIWAIT makes ImportFromDatariver wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ImportFromDatariver_OutputFcn(hObject, eventdata, handles) 
...
[FileName,PathName] = uigetfile2({'*.drf','Datariver File (.drf)'},'Select the Datariver source file');
