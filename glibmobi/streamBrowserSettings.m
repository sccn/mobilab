function varargout = streamBrowserSettings(varargin)
...
%      singleton*.
%
%      H = STREAMBROWSERSETTINGS returns the handle to a new STREAMBROWSERSETTINGS or the handle to
%      the existing singleton*.
%
%      STREAMBROWSERSETTINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in STREAMBROWSERSETTINGS.M with the given input arguments.
%
%      STREAMBROWSERSETTINGS('Property','Value',...) creates a new STREAMBROWSERSETTINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before streamBrowserSettings_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to streamBrowserSettings_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help streamBrowserSettings

% Last Modified by GUIDE v2.5 23-May-2012 10:45:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @streamBrowserSettings_OpeningFcn, ...
    'gui_OutputFcn',  @streamBrowserSettings_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before streamBrowserSettings is made visible.
function streamBrowserSettings_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = streamBrowserSettings_OutputFcn(hObject, eventdata, handles)
