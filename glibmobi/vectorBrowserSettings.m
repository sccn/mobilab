function varargout = vectorBrowserSettings(varargin)
...
%      singleton*.
%
%      H = VECTORBROWSERSETTINGS returns the handle to a new VECTORBROWSERSETTINGS or the handle to
%      the existing singleton*.
%
%      VECTORBROWSERSETTINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VECTORBROWSERSETTINGS.M with the given input arguments.
%
%      VECTORBROWSERSETTINGS('Property','Value',...) creates a new VECTORBROWSERSETTINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vectorBrowserSettings_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vectorBrowserSettings_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vectorBrowserSettings

% Last Modified by GUIDE v2.5 07-Nov-2011 22:13:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @vectorBrowserSettings_OpeningFcn, ...
    'gui_OutputFcn',  @vectorBrowserSettings_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before vectorBrowserSettings is made visible.
function vectorBrowserSettings_OpeningFcn(hObject, eventdata, handles, varargin)
...
set(handles.checkbox4,'Value',browserObj.showChannelNumber);
set(handles.figure1,'userData',browserObj);



% --- Outputs from this function are returned to the command line.
function varargout = vectorBrowserSettings_OutputFcn(hObject, eventdata, handles)
...
try   
    ...
    userData.showChannelNumber   = get(handles.checkbox4,'Value');
