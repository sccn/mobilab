function varargout = ribbonBrowserSettings(varargin)
...
%      singleton*.
%
%      H = RIBBONBROWSERSETTINGS returns the handle to a new RIBBONBROWSERSETTINGS or the handle to
%      the existing singleton*.
%
%      RIBBONBROWSERSETTINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RIBBONBROWSERSETTINGS.M with the given input arguments.
%
%      RIBBONBROWSERSETTINGS('Property','Value',...) creates a new RIBBONBROWSERSETTINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ribbonBrowserSettings_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ribbonBrowserSettings_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ribbonBrowserSettings

% Last Modified by GUIDE v2.5 21-May-2012 19:13:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @ribbonBrowserSettings_OpeningFcn, ...
    'gui_OutputFcn',  @ribbonBrowserSettings_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before ribbonBrowserSettings is made visible.
function ribbonBrowserSettings_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = ribbonBrowserSettings_OutputFcn(hObject, eventdata, handles)
