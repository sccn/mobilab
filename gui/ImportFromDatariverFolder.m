function varargout = ImportFromDatariverFolder(varargin)
...
%      singleton*.
%
%      H = IMPORTFROMDATARIVERFOLDER returns the handle to a new IMPORTFROMDATARIVERFOLDER or the handle to
%      the existing singleton*.
%
%      IMPORTFROMDATARIVERFOLDER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMPORTFROMDATARIVERFOLDER.M with the given input arguments.
%
%      IMPORTFROMDATARIVERFOLDER('Property','Value',...) creates a new IMPORTFROMDATARIVERFOLDER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ImportFromDatariverFolder_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ImportFromDatariverFolder_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ImportFromDatariverFolder

% Last Modified by GUIDE v2.5 30-Aug-2011 14:27:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ImportFromDatariverFolder_OpeningFcn, ...
                   'gui_OutputFcn',  @ImportFromDatariverFolder_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ImportFromDatariverFolder is made visible.
function ImportFromDatariverFolder_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ImportFromDatariverFolder (see VARARGIN)
...
% UIWAIT makes ImportFromDatariverFolder wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ImportFromDatariverFolder_OutputFcn(hObject, eventdata, handles) 
...
BDF            = get(handles.checkbox2,'value');
