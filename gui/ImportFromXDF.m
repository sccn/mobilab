function varargout = ImportFromXDF(varargin)
...
%
%      IMPORTFROMXDF('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IMPORTFROMXDF.M with the given input arguments.
%
%      IMPORTFROMXDF('Property','Value',...) creates a new IMPORTFROMXDF or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ImportFromXDF_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ImportFromXDF_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ImportFromXDF

% Last Modified by GUIDE v2.5 03-May-2012 16:46:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ImportFromXDF_OpeningFcn, ...
                   'gui_OutputFcn',  @ImportFromXDF_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ImportFromXDF is made visible.
function ImportFromXDF_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ImportFromXDF (see VARARGIN)
userData.source = [];
...
% UIWAIT makes ImportFromXDF wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ImportFromXDF_OutputFcn(hObject, eventdata, handles) 
