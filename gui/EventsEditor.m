...
% Last Modified by GUIDE v2.5 30-Jun-2012 21:27:30
...
set(handles.figure1,'Color',handles.mobilab.preferences.gui.backgroundColor)
set(handles.radiobutton1,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.radiobutton2,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.radiobutton3,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.text1,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.text2,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.text14,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.text25,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.text27,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.text25,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.text6,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.uipanel1,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.uipanel3,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.uipanel7,'BackgroundColor',handles.mobilab.preferences.gui.backgroundColor)
set(handles.pushbutton1,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.pushbutton14,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.pushbutton17,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.pushbutton8,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.popupmenu1,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.popupmenu14,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.popupmenu2,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.popupmenu3,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.popupmenu4,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.popupmenu5,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)
set(handles.popupmenu6,'BackgroundColor',handles.mobilab.preferences.gui.buttonColor)

allDataStreams = handles.mobilab.allStreams;
userData.inhibitedWindowLength = 0.25; % 250 ms
...
%if count == 1, set(handles.figure1,'Visible','off');return;end
