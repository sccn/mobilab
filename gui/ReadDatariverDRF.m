function varargout = ReadDatariverDRF(varargin)
...
%
%      READDATARIVERDRF('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in READDATARIVERDRF.M with the given input arguments.
%
%      READDATARIVERDRF('Property','Value',...) creates a new READDATARIVERDRF or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ReadDatariverDRF_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ReadDatariverDRF_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ReadDatariverDRF

% Last Modified by GUIDE v2.5 08-Jun-2012 20:05:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ReadDatariverDRF_OpeningFcn, ...
                   'gui_OutputFcn',  @ReadDatariverDRF_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ReadDatariverDRF is made visible.
function ReadDatariverDRF_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ReadDatariverDRF (see VARARGIN)
...
% UIWAIT makes ReadDatariverDRF wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ReadDatariverDRF_OutputFcn(hObject, eventdata, handles) 
