function [covariance_matrix,mixing_matrix,state_ord0,state_ord1,state_ord2,state_buffer] = asr_calibrate(data,srate,window_len,processing_delay,filter_b,filter_a)
...
% apply the filter and get the initial filter state
[data,state_ord0] = filter(filter_b,filter_a,double(data),[],2);
