...
function [wts,sph,tmpint] = cudaica(data,var2,var3,var4,var5,var6,var7,var8,var9,var10,var11,var12,var13,var14,var15,var16,var17,var18,var19,var20,var21,var22,var23,var24,var25)


global gpuDeviceNumberForCudaica

if isempty(gpuDeviceNumberForCudaica)
    gpuDeviceNumberForCudaica = 0;
end;
...
icadefs % import CUDACUDAICABINARY and SC

[p,n] = fileparts(which('cudaica'));
CUDAICABINARY = fullfile(p,n);

if ~exist('SC')
  fprintf('cudaica(): You need to update your icadefs file to include CUDACUDAICABINARY and SC.\n')
  return
end;
if exist(SC) ~= 2
...
%
   ...
   %eval_call = ['!' CUDAICABINARY '<' pwd '/' scriptfile];
   
   eval_call = ['!' CUDAICABINARY ' -d ' num2str(gpuDeviceNumberForCudaica) ' -f ' pwd '/' scriptfile];
